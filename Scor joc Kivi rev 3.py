...
class Scor_joc(MDApp):
    def build(self):
        ...
        Label_scor_joc.font_size=marime_font+20
        Scor_castigator_input = TextInput(multiline=True, font_size=marime_font + 40, foreground_color=(1, 1,0), background_color=(0, 0.5,1))
        ...
        label_scor_Tati.font_size=marime_font+50
        label_scor_Maria.font_size=marime_font+50
        ...
        popup_Maria = Popup(title='FELICITARI !', content=Label(text='A CASTIGAT MARIA!'),size_hint=(None, None), size=(400, 400))
        popup_Tata = Popup(title='FELICITARI !', content=Label(text='A CASTIGAT TATA !'), size_hint=(None, None), size=(400, 400))
