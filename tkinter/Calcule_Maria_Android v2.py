...
buton_1 = tk.Button(cadru1, text='1', borderwidth=5, width=2, height=2, font=font_butoane,command=lambda:scrie_in_casuta(1),bg='lightgreen')
buton_1.pack(side='left')
buton_2 = tk.Button(cadru1, text='2', borderwidth=5, width=2, height=2, font=font_butoane,command=lambda:scrie_in_casuta(2),bg='lightgreen')
buton_2.pack(side='left')
buton_3 = tk.Button(cadru1, text='3', borderwidth=5, width=2, height=2, font=font_butoane,command=lambda:scrie_in_casuta(3),bg='lightgreen')
buton_3.pack(side='left')
buton_4 = tk.Button(cadru1, text='4', borderwidth=5, width=2, height=2, font=font_butoane,command=lambda:scrie_in_casuta(4),bg='lightgreen')
buton_4.pack(side='left')
buton_5 = tk.Button(cadru1, text='5', borderwidth=5, width=2, height=2, font=font_butoane,command=lambda:scrie_in_casuta(5),bg='lightgreen')
buton_5.pack(side='left')
cadru2 = tk.Frame(aplicatie,height=2)
cadru2.pack( expand=True)
buton_6 = tk.Button(cadru2, text='6', borderwidth=5, width=2, height=2, font=font_butoane,command=lambda:scrie_in_casuta(6),bg='lightgreen')
buton_6.pack(side='left')
buton_7 = tk.Button(cadru2, text='7', borderwidth=5, width=2, height=2, font=font_butoane,command=lambda:scrie_in_casuta(7),bg='lightgreen')
buton_7.pack(side='left')
buton_8 = tk.Button(cadru2, text='8', borderwidth=5, width=2, height=2, font=font_butoane,command=lambda:scrie_in_casuta(8),bg='lightgreen')
buton_8.pack(side='left')
buton_9 = tk.Button(cadru2, text='9', borderwidth=5, width=2, height=2, font=font_butoane,command=lambda:scrie_in_casuta(9),bg='lightgreen')
buton_9.pack(side='left')
buton_del = tk.Button(cadru2, text='<-', borderwidth=5, width=2, height=2, font=font_butoane,command=lambda:casuta_text.delete(0,tk.END),bg='red')
